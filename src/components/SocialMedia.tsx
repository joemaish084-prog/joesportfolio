...
const caseStudies = [
  {
    ...
    achievements: [
      "Managed social media accounts with strategic content creation",
      "Developed creative marketing strategies that significantly boosted engagement",
      "Executed 12+ promotional campaigns driving brand visibility",
    ],
  },
  {
    ...
    achievements: [
      "Spearheaded content creation maintaining brand identity",
      "Designed 30+ multimedia assets boosting brand visibility",
      "Transformed campaign data into actionable insights",
    ],
  },
];
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16 space-y-4">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Proven track record of driving engagement and building brand presence across platforms
          </p>
        </div>
