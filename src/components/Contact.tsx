...
const socialIcons = [
  { href: "https://www.behance.net/joemaish", label: "Behance", color: "hover:text-[#1769ff]", icon: (
    <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
      <path d="M22 7h-7V5h7v2zm1.726 10c-.442 1.297-2.029 3-5.101 3-3.074 0-5.564-1.729-5.564-5.675 0-3.91 2.325-5.92 5.466-5.92 3.082 0 4.964 1.782 5.375 4.426.078.506.109 1.188.095 2.14H15.97c.13 3.211 3.483 3.312 4.588 2.029h3.168zm-7.686-4h4.965c-.105-1.547-1.136-2.219-2.477-2.219-1.466 0-2.277.768-2.488 2.219zm-9.574 6.988H0V5.021h6.953c5.476.081 5.58 5.444 2.72 6.906 3.461 1.26 3.577 8.061-3.207 8.061zM3 11h3.584c2.508 0 2.906-3-.312-3H3v3zm3.391 3H3v3.016h3.341c3.055 0 2.868-3.016.05-3.016z"/>
    </svg>
  )},
  { href: "https://www.linkedin.com/in/joseph-isaac-m-33a9a611b/", label: "LinkedIn", color: "hover:text-[#0077b5]", icon: <Linkedin className="h-5 w-5" /> },
  { href: "https://x.com/Joemkush15", label: "X", color: "hover:text-[#1da1f2]", icon: <Twitter className="h-5 w-5" /> },
  { href: "https://www.instagram.com/m_k_ush_/", label: "Instagram", color: "hover:text-[#e4405f]", icon: <Instagram className="h-5 w-5" /> },
];
...
export function Contact() {
  ...
  const validate = (): boolean => {
    ...
    if (!formData.email.trim() || !emailRegex.test(formData.email.trim())) newErrors.email = "Please enter a valid email address";
          ...
          <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
              ...
              <div className="space-y-8">
                <div>
                  ...
                  <div className="space-y-4">
                    <a href="mailto:joemaish084@gmail.com" className="flex items-center gap-3 text-muted-foreground hover:text-primary transition-colors group">
                ...
                <div>
                  ...
                  <div className="flex gap-3">
                    {socialIcons.map((social, i) => (
                      <ScrollReveal key={social.label} direction="scale" delay={0.3 + i * 0.1} duration={0.3}>
                        <a
                          href={social.href}
                          target="_blank"
            ...
            <ScrollReveal direction="up" delay={0.2}>
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <Button type="submit" size="lg" className="w-full shadow-elegant btn-hover" disabled={isSending}>
                  {isSending ? (<><Loader2 className="mr-2 h-4 w-4 animate-spin" />Sending...</>) : "Send Message"}
                </Button>
              </form>
            </ScrollReveal>
          </div>
